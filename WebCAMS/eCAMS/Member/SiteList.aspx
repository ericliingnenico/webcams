<%@ Page Language="vb" MasterPageFile="~/MemberMasterPage.master" AutoEventWireup="false" Inherits="eCAMS.SiteList" Codebehind="SiteList.aspx.vb" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
	...
	<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
		...
		<TR>
			<TD width="10"></TD>
			<TD>
			            <asp:datagrid id="grdJob" runat="server" CssClass="FormGrid" Width="100%" OnPageIndexChanged="grdJob_PageIndexChanged"
