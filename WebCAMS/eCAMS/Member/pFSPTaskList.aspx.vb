...
'<!--$$Author: Bo $-->
'<!--$$Date: 31/12/10 15:50 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/pFSPTaskList.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
Imports System.Data
...
#Region "Function"
        ...
        Private Sub BindGrid()
            ...
            dlResult = m_DataLayer.GetFSPOpenTaskList(m_DataLayer.SelectedAssignedTo, 2)
