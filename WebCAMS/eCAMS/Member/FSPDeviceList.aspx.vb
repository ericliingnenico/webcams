...
'<!--$$Author: Bo $-->
'<!--$$Date: 31/12/10 15:49 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/FSPDeviceList.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
Option Strict On
Imports System.Data
...
#Region "Function"
    ...
    Private Sub SetDE()
        Me.PageTitle = "FSP Device List"

        SearchAgainURL.Text = "" ''"Search again"
        SearchAgainURL.NavigateUrl = "../Member/FSPDeviceSearch.aspx"
    End Sub
    Private Sub BindGrid()
        ...
        dlResult = m_DataLayer.GetFSPDeviceListBySerial(m_DataLayer.SelectedSerialForDeviceSearch, 1)
