...
'<!--$$Author: Bo $-->
'<!--$$Date: 31/12/10 15:49 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/FSPJobExceptionList.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
Option Strict On
Imports System.Data
...
Partial Class FSPJobExceptionList
...
#Region "Function"
    ...
    Private Sub BindGrid()
        ...
        dlResult = m_DataLayer.GetFSPExceptionList(m_DataLayer.CurrentUserInformation.FSPID)
