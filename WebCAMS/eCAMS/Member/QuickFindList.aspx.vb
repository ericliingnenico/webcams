...
'<!--$$Author: Bo $-->
'<!--$$Date: 31/12/10 15:50 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/QuickFindList.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
...
'
' Description: 
'   Quick find results page
'----------------------------------------------------------------
Partial Class QuickFindList
...
#Region "Function"
    ...
    Private Sub SetDE()
        ''set page title
        Me.PageTitle = "Quick Find Results"

        ''Set SearchAgainURL
        SearchAgainURL.NavigateUrl = "../Member/QuickFind.aspx"
    ...
    Private Sub BindGrid()
        ...
        grdJob.PageSize = m_DataLayer.SelectedPageSize
            ...
            dlResult = m_DataLayer.GetQuickFindJobs(m_DataLayer.SelectedClientIDForQuickFind,
                                        m_DataLayer.SelectedScopeForQuickFind,
...
#Region "Event"
    ...
    Protected Sub grdJob_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles grdJob.PageIndexChanged
