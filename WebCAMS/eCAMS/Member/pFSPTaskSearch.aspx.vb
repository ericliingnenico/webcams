...
'<!--$$Author: Bo $-->
'<!--$$Date: 31/12/10 15:50 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/pFSPTaskSearch.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
Namespace eCAMS

Partial Class pFSPTaskSearch
...
#Region "Event"
    Private Sub btnSearch_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.ServerClick
        ...
        Call Response.Redirect("pFSPTaskList.aspx")
    End Sub
