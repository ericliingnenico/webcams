...
'<!--$$Author: Bo $-->
'<!--$$Date: 16/05/11 14:50 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/FSPPartInventory.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
Option Strict On
Imports System.Data
...
Partial Class FSPPartInventory
...
#End Region
 ...
 #Region "Function"
    ...
    Protected Overrides Sub GetContext()
        With Request
            If Not .Item("m") is nothing then
                m_DataLayer.PartsInventoryMode = Convert.ToInt32(.Item("m"))
            End If
        End With
    End Sub
    ...
    Private Sub SetDE()
        Me.PageTitle = "FSP Parts Inventory"
        If m_DataLayer.PartsInventoryMode = 1
            Me.lblUserPrompt.Text = "Please stock count the parts on hand and adjust NewQtyOnHand accordingly"
        else
            Me.lblUserPrompt.Text = "To raise new parts request, please enter quantity of order into QtyOrder, otherwise leave it as ZERO"
        End If
    ...
    Private Sub BindGrid()
        ...
        dlResult = m_DataLayer.GetFSPPartInventory(m_DataLayer.PartsInventoryMode)
...
#Region "Event"
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim qtyOnHands As String
        partIDs = Request.Item("txtPartID")
        qtyOnHands = Request.Item("txtQtyOnHand")

        If partIDs.Trim.Length > 0 Then

            ''Submit the Parts received
            If m_DataLayer.FSPSavePartInventory(partIDs, qtyOnHands,m_DataLayer.PartsInventoryMode) = DataLayerResult.Success Then
                Call BindGrid()
            End If
        End If
    End Sub
