<%@ Page Language="vb" AutoEventWireup="false" Inherits="eCAMS.Login" Codebehind="Login.aspx.vb" %>

<%@ Register Src="../UserControl/EEPageFooter.ascx" TagName="EEPageFooter" TagPrefix="uc2" %>

<%@ Register Src="../UserControl/EEPageHeader.ascx" TagName="EEPageHeader" TagPrefix="uc1" %>
...
<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%" border="0">
	<TR>
		<TD colSpan="2">
            <uc1:EEPageHeader ID="EEPageHeader1" runat="server" />
	...
	<tr>
		...
		<TD vAlign="top" colSpan="2">
						<table cellSpacing="0" cellPadding="5" width="270" border="0">
							<tr bgColor="#6375DE">
								<td align="left" height="25" style="width: 281px"><font face="Arial" color="white"><b class="FormHeaderWhite">Login</b></font>
								</td>
							</tr>
							<tr bgColor="#eeeeee">						
								<td height="25" style="WIDTH: 281px">
		...
		<TABLE id="tblFooter" width="100%">
			<TR>
				<TD vAlign="top">
                    <uc2:EEPageFooter ID="EEPageFooter1" runat="server" />
				</TD>
			</TR>
		</TABLE>
