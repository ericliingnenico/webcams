...
'<!--$$Author: Bo $-->
'<!--$$Date: 31/12/10 15:50 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/PopupGrid.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
Option Strict On
...
#Region "Function"
        ...
        Private Sub SetDE()
            Me.PageTitle = "GridView"
            Select Case caseID
                Case 1
                    lblListInfo.Text = String.Format("JobEquipment (JobID: {0}), ", jobID)
            End Select
        End Sub
        Private Sub BindGrid()
            ...
            Select Case caseID
                Case 1
                    dlResult = m_DataLayer.GetFSPJobEquipmentHistory(jobID)
