<%@ Page Language="vb" MasterPageFile="~/MemberMasterPage.master" AutoEventWireup="false" Inherits="eCAMS.MaintainPWD" Codebehind="MaintainPWD.aspx.vb" %>
...
<%@ Register Src="../UserControl/UserPasswordAlert.ascx" TagName="UserPasswordAlert"
    TagPrefix="uc1" %>		
				<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="309" border="0" style="WIDTH: 309px; HEIGHT: 118px">
					...
					<tr>
						<td colspan="6">
							<asp:Label id="lblFormTitle2" runat="server" CssClass="FormTitle"></asp:Label>
						</td>
					</tr>
					<tr>
						<td colspan="6">
                ...
                <asp:Panel ID="panelPasswordDE" runat="server">
					<tr>
						<td colspan="3">
							<asp:label id="Label9" runat="server" CssClass="FormDEHint">Min 8 characters (14 for admin ), at least one uppercase letter, one lowercase letter and one numbers.(NO  special character)<br/><br/>Please ask Administrator  for assistance to reset your password if it has expired</asp:label>
						</td>
					</tr>					
					<TR>
						<TD width="10"></TD>
					...
					<TR>
						...
						<TD style="width: 135px">
							<INPUT class="FormDEField" id="txtReTypeNewPWD" type="password" name="txtReTypeNewPWD"
								runat="server"></TD>
					</TR>
					<TR>
						<TD width="10"></TD>
                    ...
                    <asp:RegularExpressionValidator ID="revPassword" runat="server" ControlToValidate="txtNewPWD"
                            Display="None" ErrorMessage="Min 8 characters (14 for admin ), at least one uppercase letter, one lowercase letter and one numbers.(NO  special character)" ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$"></asp:RegularExpressionValidator>
