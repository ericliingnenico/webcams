<%@ Page Language="vb" MasterPageFile="~/pFSP.master" AutoEventWireup="false" Inherits="eCAMS.pFSPTaskList" Codebehind="pFSPTaskList.aspx.vb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <TABLE id="Table2" cellSpacing="1" cellPadding="1" border="0">
		<TR>
			<TD width="10"></TD>
			<TD>
				<asp:HyperLink id="SearchAgainURL" runat="server" NavigateUrl="pFSPTaskSearch.aspx" CssClass="pFormTitle">Search &gt&gt</asp:HyperLink>&nbsp;
				<asp:label id="lblListInfo" runat="server" CssClass="pMemberInfo"></asp:label>
			</TD>
			<TD width="10"></TD>
		</TR>
		<TR>
