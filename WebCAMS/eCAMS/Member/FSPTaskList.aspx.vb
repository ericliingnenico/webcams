...
'<!--$$Author: Bo $-->
'<!--$$Date: 31/12/10 15:50 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/FSPTaskList.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
Imports System.Data
...
#Region "Function"
            ...
            With Request
                If .Item("List") = "1" Then
                    If m_DataLayer.SelectedAssignedTo = String.Empty Then
                        m_DataLayer.SelectedAssignedTo = m_DataLayer.CurrentUserInformation.FSPID
        ...
        Private Sub SetDE()
            Me.PageTitle = "Task List"

            SearchAgainURL.Text = "" ''"Search again"
            SearchAgainURL.NavigateUrl = "../Member/FSPTaskSearch.aspx"
        End Sub
        Private Sub BindGrid()
            ...
            dlResult = m_DataLayer.GetFSPOpenTaskList(m_DataLayer.SelectedAssignedTo, 1)
...
#Region "Event"
        ...
        Protected Overrides Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            ''only trun on auto refresh when time is between 6:00 and 22:00
