...
'<!--$$Author: Bo $-->
'<!--$$Date: 31/12/10 15:50 $-->
'<!--$$Logfile: /eCAMSSource2010/eCAMS/Member/SiteEquipmentList.aspx.vb $-->
'<!--$$NoKeywords: $-->
#End Region
Option Strict On
Imports System.Data
...
'----------------------------------------------------------------
' Namespace: eCAMS
' Class: SiteEquipmentList
'
' Description: 
'   Site Equipment search result page
'----------------------------------------------------------------
Partial Class SiteEquipmentList
...
#Region "Function"
    ...
    Protected Overrides Sub GetContext()
        With Request
            ...
            If .QueryString("CID") <> "" Then
                m_DataLayer.SelectedClientIDForSiteEquipment = .QueryString("CID").Trim
            End If

            If .QueryString("TID") <> "" Then
                m_DataLayer.SelectedTerminalIDForSiteEquipment = .QueryString("TID").Trim
            End If
        End With
    End Sub
    '----------------------------------------------------------------
    ...
    Private Sub SetDE()
        ''set page title
        Me.PageTitle = "Site Equipment List"

        ''Set SearchAgainURL
        SearchAgainURL.NavigateUrl = "../Member/SiteEquipmentSearch.aspx"
    ...
    Private Sub BindGrid()
        ...
        dlResult = m_DataLayer.GetSiteEquipments(m_DataLayer.SelectedClientIDForSiteEquipment, m_DataLayer.SelectedTerminalIDForSiteEquipment)
